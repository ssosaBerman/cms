...
//     /*** an array of rules ***/
//     $rules_array = array(
//         'name'=>array('type'=>'string',  'required'=>true, 'min'=>1, 'max'=>50, 'trim'=>true),
//         'email'=>array('type'=>'email', 'required'=>true, 'min'=>1, 'max'=>120, 'trim'=>true));
...
//     $val->addRule('username', 'string', true, 6, 30, true)
//         ->addRule('password', 'string', true, 6, 15, false);
